...
class Summary extends Component {
    ...
    let leftCustomHeader = (
      <div>
        <span style={{ fontWeight: "bold" }}>
          <a onClick={this.changeSummaryPos}>Change summary position</a>
        </span>
      </div>
    );
      ...
      <div>
        ...
        <div>
          <h3 style={{ textAlign: "center" }}>
            Summary
            <ViewSrcCode srcCodeUrl="https://github.com/StephenChou1017/react-big-scheduler/blob/master/example/Summary.js" />
          </h3>
          <Scheduler
  ...
  changeSummaryPos = () => {
    ...
    schedulerData.config.summaryPos =
      schedulerData.config.summaryPos === SummaryPos.TopRight
