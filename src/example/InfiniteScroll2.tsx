...
class InfiniteScroll2 extends Component {
      ...
      <div>
        ...
        <div>
          <h3 style={{ textAlign: "center" }}>
            Infinite scroll 2
            <ViewSrcCode srcCodeUrl="https://github.com/StephenChou1017/react-big-scheduler/blob/master/example/InfiniteScroll2.js" />
          </h3>
          <Scheduler
  ...
  getCustomDate = (schedulerData, num, date = undefined) => {
    ...
    if (num === 1) {
      ...
      endDate = schedulerData
        .localeMoment(schedulerData.endDate)
        .add(1, "days")
        .format(DATE_FORMAT);
    } else if (num === -1) {
      startDate = schedulerData
        .localeMoment(schedulerData.startDate)
        .add(-1, "days")
        .format(DATE_FORMAT);
